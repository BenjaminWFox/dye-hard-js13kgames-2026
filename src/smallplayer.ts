...
// Shared pad preset (instruments 0, 2, 3, 4). Empty `f` columns never mutate `i`.
const PAD = [2,100,128,0,3,201,128,0,0,0,5,6,58,0,0,0,0,195,6,1,2,135,0,0,32,147,6,121,6];
